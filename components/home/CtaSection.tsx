  ...
  return (
    <section className="relative border-t border-white/10 py-24">
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <Reveal variant="up" delay={100} distance={24} duration={700}>
          <h2 className="text-3xl font-bold tracking-tight text-balance text-white sm:text-5xl">
            지금 바로 시작하세요
          </h2>
        </Reveal>

        <Reveal variant="up" delay={180} distance={20} duration={700}>
        ...
        <Reveal variant="scale" delay={260} distance={18} duration={700}>
