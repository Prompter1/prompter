      ...
      <section className="grow px-4 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="text-surface-300 space-y-8 text-sm leading-relaxed">
            ...
            <div className="bg-brand-500/5 border-brand-500/20 rounded-3xl border p-8">
              ...
              <ul className="list-disc space-y-1 pl-5">
                ...
                <ul className="list-disc space-y-2 pl-5">
                  ...
                  <li>
                    판매자 유형(개인/사업자)에 따라 필요한 정보 제출 및 세무
                    처리 절차를 이행하지 않을 경우, 정산이 보류될 수 있습니다.
                  </li>
                </ul>
              </ul>
            </div>
            ...
            <div className="bg-surface-800/20 border-surface-700/50 rounded-3xl border p-8">
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <ShieldAlert className="text-brand-400 h-5 w-5" /> 4. 세무 처리
                및 정산 책임
              </h2>

              <p className="mb-4">
                Prompter는 중개 플랫폼으로서 판매자와 구매자 간 거래를 지원하며,
                판매자 유형에 따라 세무 처리 방식이 구분됩니다.
              </p>

              <ul className="list-disc space-y-3 pl-5 text-sm">
                <li>
                  <strong>개인 판매자:</strong> 개인 판매자는 관련 법령에 따라
                  원천징수 대상에 해당할 수 있으며, 플랫폼은 정산 시 일정 비율의
                  세액(예: 3.3%)을 원천징수한 후 지급합니다. 또한, 플랫폼은
                  지급명세서 제출 등 관련 세무 신고를 수행합니다.
                </li>

                <li>
                  <strong>사업자 판매자:</strong> 사업자 판매자는 독립된
                  사업자로서 모든 세무 신고 및 납세 의무를 직접 이행해야 합니다.
                  정산을 위해 판매자는 플랫폼을 공급받는 자로 하여 세금계산서를
                  발행해야 하며, 발행 확인이 완료된 경우에 한하여 정산이
                  진행됩니다.
                </li>

                <li>
                  판매자는 본인의 세무 상태(개인/사업자)에 맞는 정보를 정확하게
                  제공해야 하며, 허위 정보 제공 시 정산 보류 또는 서비스 이용
                  제한이 발생할 수 있습니다.
                </li>

                <li>
                  관련 법령 및 정책 변경에 따라 세무 처리 방식 및 정산 절차는
                  변경될 수 있으며, 변경 사항은 사전 공지 후 적용됩니다.
                </li>

                <li>
                  판매자의 세무 신고 및 납세 의무는 각 판매자 본인에게 있으며,
                  플랫폼은 관련 법령에 따른 범위 내에서 필요한 지원 및 안내를
                  제공합니다.
                </li>
              </ul>
            </div>
