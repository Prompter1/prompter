...
import { Lock, Eye, Database, Share2, ShieldCheck, UserCheck, Cookie, Bell } from 'lucide-react'
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-12">
            ...
            <p className="text-surface-400">
              Prompter는 「개인정보보호법」을 준수하며 이용자의 개인정보를 소중히
              보호합니다.
            </p>
          ...
          <div className="bg-surface-800/20 border-surface-700/50 text-surface-300 space-y-10 rounded-3xl border p-8 leading-relaxed shadow-xl md:p-12">
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Eye className="text-brand-400 h-5 w-5" /> 1. 수집하는 개인정보 항목
              </h2>
              ...
              <div className="space-y-3 text-sm">
                <div className="bg-surface-900/40 rounded-xl p-4">
                  <p className="text-surface-200 mb-1 font-semibold">회원가입 시</p>
                  <p>이메일 주소, 소셜 계정 고유 식별자(OAuth 제공 정보), 닉네임</p>
                </div>
                <div className="bg-surface-900/40 rounded-xl p-4">
                  <p className="text-surface-200 mb-1 font-semibold">결제 시</p>
                  <p>
                    결제 수단 정보(카드사명, 마스킹된 카드번호), 거래 기록.
                    결제 정보는 PG사(토스페이먼츠)를 통해 처리되며 회사는 원본
                    카드 정보를 저장하지 않습니다.
                  </p>
                </div>
                <div className="bg-surface-900/40 rounded-xl p-4">
                  <p className="text-surface-200 mb-1 font-semibold">판매자 등록 시</p>
                  <p>사업자등록번호, 상호명, 대표자명, 사업장 주소, 세금계산서 수신 이메일</p>
                </div>
                <div className="bg-surface-900/40 rounded-xl p-4">
                  <p className="text-surface-200 mb-1 font-semibold">서비스 이용 중 자동 수집</p>
                  <p>IP 주소, 브라우저 종류 및 버전, 접속 일시, 서비스 이용 기록, 쿠키</p>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Database className="text-brand-400 h-5 w-5" /> 2. 개인정보의 이용 목적
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>서비스 제공 및 계약 이행 (프롬프트 구매·판매·열람)</li>
                <li>회원 관리 (본인 확인, 부정 이용 방지, 고객 문의 응대)</li>
                <li>결제 처리 및 정산 (판매자 수익 집계·지급, 원천징수 신고)</li>
                <li>법적 의무 이행 (전자상거래법, 조세특례제한법 등 관련 기록 보관)</li>
                <li>서비스 개선 및 통계 분석 (집계 형태의 익명화 데이터에 한함)</li>
            ...
            <section className="bg-brand-500/5 border-brand-500/20 rounded-2xl border p-6">
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Share2 className="text-brand-400 h-5 w-5" /> 3. 개인정보의 제공 및 처리 위탁
              </h2>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="bg-surface-800/50 border-surface-700/50 rounded-xl border p-4">
                  <p className="text-brand-400 mb-1 font-bold">토스페이먼츠(주)</p>
                  <p className="text-surface-400 text-xs mb-1">위탁 업무: 결제 처리 및 PG 서비스</p>
                  <p className="text-surface-500 text-xs">보유 기간: 거래 완료 후 5년 (전자상거래법)</p>
                </div>
                <div className="bg-surface-800/50 border-surface-700/50 rounded-xl border p-4">
                  <p className="text-brand-400 mb-1 font-bold">Supabase Inc.</p>
                  <p className="text-surface-400 text-xs mb-1">위탁 업무: 데이터베이스 저장 및 회원 인증</p>
                  <p className="text-surface-500 text-xs">보유 기간: 회원 탈퇴 후 즉시 파기</p>
                </div>
              </div>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <ShieldCheck className="text-brand-400 h-5 w-5" /> 4. 개인정보의 보유 및 파기
              </h2>
              <p className="mb-3 text-sm">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-surface-700/50 border-b text-left">
                      <th className="text-surface-400 py-2 pr-4 font-medium">보존 항목</th>
                      <th className="text-surface-400 py-2 pr-4 font-medium">근거 법령</th>
                      <th className="text-surface-400 py-2 font-medium">보존 기간</th>
                    </tr>
                  </thead>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Cookie className="text-brand-400 h-5 w-5" /> 5. 쿠키(Cookie) 운영
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  회사는 로그인 세션 유지, 서비스 이용 편의 제공 등을 위해
                  쿠키를 사용합니다. 쿠키는 브라우저 종료 시 삭제되는
                  세션 쿠키와 일정 기간 보관되는 영구 쿠키로 구분됩니다.
                </li>
                <li>
                  이용자는 브라우저 설정을 통해 쿠키 수신을 거부할 수 있습니다.
                  다만, 쿠키를 비활성화하면 로그인 등 일부 서비스 기능이
                  제한될 수 있습니다.
                </li>
                <li>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <UserCheck className="text-brand-400 h-5 w-5" /> 6. 정보주체의 권리
              </h2>
              <p className="mb-3 text-sm">
              ...
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  <strong className="text-surface-200">열람권:</strong>{' '}
                  자신의 개인정보 처리 현황을 확인할 수 있습니다.
                </li>
                <li>
                  <strong className="text-surface-200">정정·삭제권:</strong>{' '}
                  잘못된 정보의 정정 또는 삭제를 요청할 수 있습니다. (단,
                  법령상 보존 의무가 있는 정보는 즉시 삭제가 불가할 수 있습니다.)
                </li>
                <li>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Bell className="text-brand-400 h-5 w-5" /> 7. 개인정보 침해 시 대응
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                ...
                <li>
                  ...
                  있습니다.
                  <ul className="mt-2 list-none space-y-1 pl-0 text-xs text-surface-400">
            ...
            <section className="bg-surface-900/50 rounded-2xl p-6">
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <ShieldCheck className="text-brand-400 h-5 w-5" /> 8. 개인정보보호책임자
              </h2>
              <p className="mb-3 text-sm">
              ...
              <div className="text-sm space-y-1">
                <p><strong className="text-surface-200">성명:</strong> 차민우</p>
                <p><strong className="text-surface-200">직책:</strong> 대표</p>
                <p><strong className="text-surface-200">이메일:</strong> {CONTACT_EMAIL}</p>
                <p><strong className="text-surface-200">처리 기간:</strong> 문의 접수 후 10일 이내</p>
              </div>
            </section>
