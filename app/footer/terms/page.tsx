...
import { Scale, ShieldCheck, FileText, AlertCircle, Users, RefreshCw, Gavel } from 'lucide-react'
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-12">
            ...
            <p className="text-surface-400">
              Prompter 서비스 이용을 위해 필요한 권리와 의무 관계를 안내드립니다.
            </p>
          ...
          <div className="bg-surface-800/20 border-surface-700/50 text-surface-300 space-y-10 rounded-3xl border p-8 leading-relaxed shadow-xl md:p-12">
            ...
            <section>
              ...
              <p>
                ...
                거래 및 관련 서비스(이하 "서비스")를 이용함에 있어 회사와 이용자의
            ...
            <section>
              ...
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  <strong className="text-surface-200">"서비스"</strong>란 회사가
                  제공하는 인공지능 프롬프트 거래 플랫폼 및 부속 서비스 일체를
                  의미합니다.
                </li>
                <li>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <RefreshCw className="text-brand-400 h-5 w-5" /> 제3조 (약관의 게시 및 개정)
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  회사는 본 약관을 서비스 초기 화면 하단에 게시합니다.
                </li>
                <li>
                  회사는 「약관의 규제에 관한 법률」 및 관련 법령을 위배하지 않는
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Users className="text-brand-400 h-5 w-5" /> 제4조 (회원 가입 및 탈퇴)
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  이용자는 소셜 계정(Google, Kakao 등 OAuth 수단)을 통해 회원으로
                  가입할 수 있으며, 가입 시 본 약관에 동의한 것으로 간주합니다.
                </li>
                <li>
                ...
                <li>
                  회사는 다음 각 호에 해당하는 경우 회원 자격을 제한하거나 박탈할
                  수 있습니다: ①타인의 정보 도용, ②서비스 운영 방해, ③본 약관
                  위반, ④기타 불법·부정한 행위.
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <FileText className="text-brand-400 h-5 w-5" /> 제5조 (서비스의 제공 및 변경)
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                ...
                <li>
                  회사는 서비스 내용을 변경할 수 있으며, 중요한 변경 사항은 사전에
                  공지합니다.
                </li>
                <li>
            ...
            <section className="bg-brand-500/5 border-brand-500/20 rounded-2xl border p-6">
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <AlertCircle className="text-brand-400 h-5 w-5" /> 제6조 (청약철회 및 환불 제한)
              </h2>
              ...
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  구매자가 프롬프트 내용을 열람하거나 복사한 경우,
                  「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항
                  제5호에 따라 청약철회(환불)가 불가능합니다.
                </li>
                <li>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <ShieldCheck className="text-brand-400 h-5 w-5" /> 제7조 (지식재산권 및 사용 범위)
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                ...
                <li>
                  구매자는 구매한 프롬프트를 AI 서비스에 입력하여 결과물을 생성하는
                  용도로 <strong className="text-surface-200">비독점적·비양도적 사용권</strong>을
                  부여받습니다.
                </li>
                <li>
                  구매한 프롬프트 자체를 제3자에게 재판매, 무단 배포, 공유하는
                  행위는 엄격히 금지되며, 위반 시 저작권법에 따른 민·형사상 책임을
                  질 수 있습니다.
                </li>
                <li>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <FileText className="text-brand-400 h-5 w-5" /> 제8조 (면책조항 및 손해배상)
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                  회사는 이용자 간 거래를 중개하는 플랫폼으로서, 판매자가 등록한
                  프롬프트의 내용·성능·완결성을 보장하지 않습니다.
                </li>
                <li>
                  AI 모델의 업데이트 또는 정책 변화로 인한 프롬프트 결과 변동에
                  대해 회사는 책임을 지지 않습니다.
                </li>
                <li>
                  회사의 고의 또는 중과실로 이용자에게 손해가 발생한 경우, 회사는
                  관련 법령이 정하는 범위 내에서 손해를 배상합니다.
                </li>
                <li>
            ...
            <section>
              <h2 className="mb-4 flex items-center gap-2 text-xl font-semibold text-white">
                <Gavel className="text-brand-400 h-5 w-5" /> 제9조 (분쟁 해결 및 준거법)
              </h2>
              <ul className="list-disc space-y-2 pl-5 text-sm">
                <li>
                ...
                <li>
                  ...
                  준거법으로 하며, 관할 법원은 민사소송법상 관할 법원으로 합니다.
                </li>
              </ul>
            </section>
          </div>
