...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      '검증됨 마크가 부여된 프롬프트는 두 가지 주요 혜택을 받습니다. 첫째, 검색 결과 및 카테고리 목록에서 상위 노출 우선순위가 부여되어 더 많은 구매자에게 노출됩니다. 둘째, 프롬프트 상세 페이지에 "Verified" 뱃지가 표시되어 구매자에게 품질과 신뢰성을 보장하는 신호 역할을 합니다. 검증은 업로드 시 증빙 자료(AI 활용 스크린샷·영상)를 첨부하고 관리자 심사를 통과하면 획득할 수 있습니다.',
    icon: <ShieldCheck className="text-brand-400 h-5 w-5" />,
  },
  {
    category: '판매자',
